...
\begin{tikzpicture}[very thick, ampersand replacement=\&]
 ...
 \draw[link,onslide=<3>{ActionRed}] (a1) to (b1);
 \draw[link,onslide=<3>{ActionRed}] (a1) to (c1);
 
 \draw[link,onslide=<3-4>{ActionRed}] (b1) to (mr-1-1);
 \draw[link,onslide=<3-4>{ActionRed}] (b1) to (mr-1-2);
 \draw[link,onslide=<3>{ActionRed}] (a1) to (mr-1-3);
 \draw[link,onslide=<3>{ActionRed}] (a1) to (mr-1-4);
 \draw[link,onslide=<3>{ActionRed}] (c1) to (mr-1-5);
 \draw[link,onslide=<3>{ActionRed}] (c1) to (mr-1-6);
 \draw[link,onslide=<4>{ActionRed}] (b2) to (ml-1-1);
 \draw[link,onslide=<4>{ActionRed}] (b2) to (ml-1-2);
 ...
 \uncover<3->{
 \matrix (mx) [matrix of nodes, fill=white, below=2cm of ghost.center, nodes ={black}] {
  \& $e_1$ \& $e_2$ \& $e_3$ \& $e_4$ \& $e_5$ \& $e_6$ \&  $e_7$ \& $e_8$ \\
 ...
 \draw[decorate,decoration={brace,mirror}] (mx-2-1.north west) -- (mx-4-1.south west) node[black,midway,xshift=-0.5em] {$\Theta^1$}; 

 \draw[decorate,decoration={brace,mirror}] (mx-5-1.north west) -- (mx-7-1.south west) node[black,midway,xshift=-0.5em] {$\Theta^1$}; 
