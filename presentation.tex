...
\begin{frame}{Network learned from the \textit{S. cerevisiae} data}
  \vskip5mm
  \begin{tikzpicture}
   \node[anchor=north west,inner sep=0] at (-10mm,10mm) {\includegraphics[width=14cm]{recomb-2018-short-names.pdf}};
   ...
   \uncover<4>{
    ...
    \node[text block, text width=8cm] at (35mm,-4cm) {Msn2 is known to be regulated by Hog1, Pde2, and Snf1, and Pde2 plays a more significant role in regulating Msn2 during salt stress};  
   }
